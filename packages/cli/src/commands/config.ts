...
import { readConfig, readConfigSyncConfig, writeConfigSyncConfig, enableConfigDomain, disableConfigDomain, readLastSyncedState } from 'ide-sync-core';
import { runDetectors, ALL_FAMILIES } from 'ide-sync-core';
import type { IDEFamily } from 'ide-sync-core';
import { ALL_CONFIG_DOMAINS, type ConfigDomain } from 'ide-sync-core';
import { readConfigSnapshot } from 'ide-sync-core';
import { configDiff, configReplicate, previewConfigChanges } from 'ide-sync-core';
import { backupFiles } from 'ide-sync-core';
