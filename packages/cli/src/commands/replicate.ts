...
import { diffExtensions } from 'ide-sync-core';
import { buildPlan, summarizePlan } from 'ide-sync-core';
import type { Plan, PlanAction } from 'ide-sync-core';
import { getInstaller } from 'ide-sync-core';
import { resolveExtension } from 'ide-sync-core';
import { getCliInstallHint } from 'ide-sync-core';
import type { ResolverOptions } from 'ide-sync-core';
